...
$email = filter_var($eml, FILTER_VALIDATE_EMAIL);
if (!$email) {
   $error .="<p>Invalid email address please type a valid email address!</p>";
   }else{
   $sel_query = "SELECT * FROM `auth` WHERE eml='".$eml."'";
...
$output.='<p>-------------------------------------------------------------</p>';
$output.='<p><a href="https://www.ShoeStore.com/forgot-password/reset-password.php?
key='.$key.'&email='.$email.'&action=reset" target="_blank">
https://www.Shoestore.com/forgot-password/reset-password.php
...
$output.='<p>Thanks,</p>';
$output.='<p>ShoeStore Team</p>';
$body = $output; 
$subject = "Password Recovery - ShoeStore.com";
