...
if (isset($_POST['submit'])) {
    $cat = $_POST['cat'];
    $sql = "INSERT INTO tbl_category VALUES (null,'" . $cat . "')";
    $res = mysqli_query($connection, $sql);
    if ($res) {
        echo "<script>alert('Cat added successfull'); window.location='color.php'; </script>";
    } else {
        ...
        <div class="col-md-6 " id="add-movies-container">
            ...
            <form method="POST" id="form" action="">
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" name="cat" id="cat" aria-describedby="helpId" onkeyup="Cat()" autocomplete="off">
                    <div id="a"></div>
                </div>
...
<script>
    ...
    function Cat() {
        var user = document.getElementById("cat").value;
        var letters = /^[A-Za-z]+$/;
